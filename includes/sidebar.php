<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    <div class="app-sidebar-header d-flex flex-stack d-none d-lg-flex pt-8 pb-2" id="kt_app_sidebar_header">
        ...
        <a href="index" class="app-sidebar-logo">
            <img alt="Logo" src="img/logo1.svg" class="h-35px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
            <img alt="Logo" src="img/logo1.svg" class="h-35px theme-dark-show" />
        </a>
        <!--end::Logo-->
            ...
            <div class="app-sidebar-menu-secondary menu menu-rounded menu-column mb-6">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link active" href="../../demo38/dist/apps/projects/project.html">
                        ...
                        <!--end::Bullet-->
                        <!--begin::Title-->
                        <span class="menu-title">Brevemente</span>
                        <!--end::Title-->
                    </a>
                    <!--end::Menu link-->
                </div>
